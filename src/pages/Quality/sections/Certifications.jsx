...
export default function Certifications() {
  ...
  return (
    <div id="quality-certifications" className="w-full bg-page dark:bg-surface-900/40 py-[40px] lg:py-[60px] border-b border-[#eee] dark:border-surface-800/40 overflow-hidden">
      <motion.section
