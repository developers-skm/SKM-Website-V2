...
export default function Traceability({ onPageChange }) {
  ...
  return (
    <div id="quality-traceability" className="w-full bg-page pt-[100px] sm:pt-[110px] lg:pt-[120px] pb-[40px] lg:pb-[60px] border-b border-[#eee] overflow-hidden">
      <motion.section
      ...
      >
        ...
        >
          {[
            ...
            <motion.div
              key={i}
              whileHover={{ y: -6 }}
              className="relative rounded-[20px] border border-[#eee] bg-white p-3 shadow-[5px_3px_40px_rgba(0,72,88,0.06)] hover:shadow-[5px_3px_40px_rgba(0,72,88,0.14)] hover:border-brand-600/30 transition-all duration-300 overflow-hidden group"
            >
              ...
              <div className="px-4 py-3 text-center">
                <p className="text-xs font-bold text-surface-500 uppercase tracking-wider m-0">
                  {img.label}
                </p>
              </div>
            </motion.div>
        ...
        >
          {traceabilitySteps.map((step, i) => (
            <motion.div
              ...
              className="flex items-start gap-4 p-5 bg-white border border-[#eee] rounded-[10px] hover:border-brand-600/30 hover:shadow-[5px_3px_40px_rgba(0,72,88,0.1)] transition-all duration-300 group"
            >
              <span className="font-heading font-bold text-[22px] flex-shrink-0 leading-none text-brand-600">
                {step.step}
              </span>
              <div className="flex flex-col gap-1">
                <h4 className="font-heading font-bold text-[14px] text-heading m-0 tracking-tight">
                  {step.label}
                </h4>
        ...
        <motion.div
          variants={itemVariants}
          className="bg-white border border-[#eee] rounded-[10px] p-6 sm:p-8 lg:p-10 shadow-[5px_3px_40px_rgba(0,72,88,0.06)] hover:border-brand-600/30 transition-all duration-300 flex flex-col gap-8"
        >
          {/* Header */}
          <div className="flex flex-col md:flex-row gap-6 md:items-center justify-between border-b border-surface-100 pb-6">
            <div className="flex flex-col gap-2">
              <span className="font-body text-[11px] font-bold text-brand-600 uppercase tracking-wider">
                System Overview
              </span>
              <h4 className="font-heading font-bold text-[22px] sm:text-[26px] text-heading m-0 tracking-tight leading-none">
                End-to-End Traceability
              </h4>
            </div>
            <p className="text-sm sm:text-base text-surface-550 max-w-xl leading-relaxed m-0 font-body md:text-right">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="flex flex-col gap-5">
              <h5 className="text-xs font-bold text-surface-400 uppercase tracking-widest m-0">
                Transformation Stages Monitored
              </h5>
              <div className="flex flex-col gap-4">
                <div className="flex gap-4 items-start p-4 bg-surface-50 border border-surface-100 rounded-2xl">
                  <span className="w-7 h-7 rounded-lg bg-brand-50 border border-brand-100 text-brand-600 flex items-center justify-center font-bold text-xs flex-shrink-0 mt-0.5">
                    1
                  </span>
                  <div className="flex flex-col gap-1">
                    <span className="text-sm font-bold text-surface-800 leading-tight">
                      Feed Input to Egg
                    </span>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex gap-4 items-start">
                ...
                <div className="flex flex-col gap-1">
                  <h5 className="text-sm font-bold text-surface-850 m-0">
                    Logistics &amp; Packaging
                  </h5>
                  <p className="text-xs text-surface-500 leading-relaxed m-0 font-body">
