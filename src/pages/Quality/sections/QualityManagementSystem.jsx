...
export default function QualityManagementSystem() {
  ...
  return (
    <div id="quality-qms" className="w-full bg-page pt-[100px] sm:pt-[110px] lg:pt-[120px] pb-[40px] lg:pb-[60px] overflow-hidden">
      <motion.section
      ...
      >
        ...
        <div className="text-center flex flex-col items-center gap-4">
          ...
          <motion.p
            variants={itemVariants}
            className="font-body text-[16px] text-surface-500 max-w-4xl leading-[30px] m-0"
          >
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-14 items-start">
          ...
          >
            <div className="rounded-[20px] border border-[#eee] bg-white p-4 shadow-[5px_3px_40px_rgba(0,72,88,0.06)] hover:shadow-[5px_3px_40px_rgba(0,72,88,0.14)] hover:border-brand-600/30 transition-all duration-300 overflow-hidden group">
              <img
                src={QMSChart}
          ...
          >
            {labImages.map((img, i) => (
              <motion.div
                key={i}
                whileHover={{ x: 6 }}
                className="relative rounded-[20px] border border-[#eee] overflow-hidden group hover:shadow-[5px_3px_40px_rgba(0,72,88,0.1)] hover:border-brand-600/30 transition-all duration-300"
              >
        ...
        <div className="flex flex-col gap-6">
          <motion.h3
            variants={itemVariants}
            className="text-sm font-bold text-surface-400 uppercase tracking-widest m-0 text-center"
          >
          ...
          >
            {qmsPillars.map((pillar, i) => (
              <motion.div
                ...
                variants={itemVariants}
                whileHover={{ y: -5 }}
                className="p-5 bg-white border border-[#eee] rounded-[10px] flex flex-col gap-3 hover:border-brand-600/30 hover:shadow-[5px_3px_40px_rgba(0,72,88,0.1)] transition-all duration-300 group"
              >
                <div className="w-9 h-9 rounded-[8px] bg-brand-600/6 border border-brand-600/12 flex items-center justify-center text-brand-600 group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                  {pillar.icon}
                </div>
        ...
        <motion.div
          variants={itemVariants}
          className="relative overflow-hidden rounded-[10px] bg-surface-50 border border-[#eee] p-6 sm:p-8 lg:p-10 flex flex-col sm:flex-row items-center gap-6 sm:gap-8 shadow-[5px_3px_40px_rgba(0,72,88,0.05)]"
        >
          <div className="flex-shrink-0 w-14 h-14 rounded-[10px] bg-brand-600/6 border border-brand-600/12 flex items-center justify-center text-brand-600">
            <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
              <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
            </svg>
          </div>
          <div className="flex flex-col gap-2 text-center sm:text-left">
            <h4 className="font-heading font-bold text-[16px] sm:text-[18px] text-heading m-0 tracking-tight uppercase">
              HACCP Food Safety Framework
            </h4>
            <p className="text-sm text-surface-500 leading-relaxed m-0 font-body">
