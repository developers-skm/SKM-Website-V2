              ...
              >
                ...
                <div className="flex flex-col gap-2 px-7 pt-6 pb-7">
                  ...
                  <button
                    ...
                    className="mt-3 self-start inline-flex items-center gap-1.5 font-body font-bold text-[12.5px] uppercase tracking-[0.05em] text-brand-600 dark:text-brand-400 hover:text-[#a80000] cursor-pointer bg-transparent border-none p-0"
                  >
