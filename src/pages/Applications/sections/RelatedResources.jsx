          ...
          {flyers.map((product) => {
            ...
            return (
              <motion.div
                ...
                className="group flex items-center justify-between gap-4 rounded-[20px] border border-surface-200/60 dark:border-surface-800 hover:border-brand-600/40 bg-white dark:bg-surface-900/40 px-6 py-6 transition-colors duration-300"
              >
                <div className="flex items-center gap-4 min-w-0">
                  <span className="flex-shrink-0 flex items-center justify-center w-11 h-11 rounded-[12px] bg-brand-600/6 dark:bg-brand-950/40 border border-brand-600/12 dark:border-brand-900/40 transition-transform duration-300 group-hover:-translate-y-0.5">
                ...
                <a
                  ...
                  className={`flex-shrink-0 font-body font-bold text-[12px] uppercase tracking-[0.05em] px-4 py-2 rounded-full border transition-all duration-200 ${
                    isOpened
                      ...
                      : 'text-brand-600 dark:text-brand-400 hover:text-[#a80000] border-surface-200 dark:border-surface-700 hover:border-brand-600/30'
                  }`}
                >
