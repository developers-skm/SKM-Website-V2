      ...
      >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 w-full">
          ...
          <motion.div
            ...
            whileHover={{ y: -6 }}
            className="relative overflow-hidden rounded-[10px] bg-white border border-[#eee] shadow-[5px_3px_40px_rgba(0,72,88,0.07)] hover:shadow-[5px_3px_40px_rgba(0,72,88,0.16)] p-8 sm:p-10 md:p-12 flex flex-col justify-between group transition-all duration-300"
          >
            <div className="absolute top-0 right-0 w-80 h-80 bg-brand-600/3 rounded-full blur-3xl pointer-events-none" />

            <div className="relative z-10 flex flex-col gap-8">
              <div className="flex items-center justify-between">
                <span className="font-body text-[11px] font-bold uppercase tracking-widest text-brand-600 bg-brand-600/6 border border-brand-600/12 px-3 py-1 rounded">
                  Our Vision
                </span>
              ...
              <blockquote className="m-0 border-l-4 border-brand-600 pl-6 py-2 bg-[rgba(228, 10, 24,0.02)] rounded-r-[10px] text-left flex flex-col gap-3">
                ...
                <p className="font-body text-[18px] sm:text-[20px] font-medium leading-[30px] text-surface-700 m-0 italic">
            ...
            <div className="relative z-10 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3 text-left">
                {missionItems.map((item, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-4 p-3 bg-surface-50 border border-[#eee] rounded-[8px] hover:border-brand-600/20 transition-colors duration-200"
                  >
                    ...
                    <p className="font-body text-[15px] font-medium text-surface-700 leading-snug m-0">
                      {item.desc}
                    </p>
                  </div>
                ))}
