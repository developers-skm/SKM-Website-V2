...
export default function BrandPhilosophy() {
  return (
    <div className="w-full bg-page pt-[110px] pb-[40px] sm:pt-[130px] lg:pt-[60px] lg:pb-[60px] border-b border-[#eee] overflow-hidden">
      <motion.section
      ...
      >
        ...
        <div className="flex-1 text-left flex flex-col gap-6 w-full">
          ...
          >
            ...
            <h3 className="font-heading text-[22px] sm:text-[26px] font-bold tracking-wider text-brand-600 m-0 mt-2 uppercase">
          ...
          <div className="flex flex-col gap-4">
            <motion.p variants={itemVariants} className="font-body text-[16px] text-surface-500 leading-[30px] m-0">
              <strong className="text-surface-800">'THINKING OUT OF THE SHELL'</strong> is a reflection of the curious spirit and culture of innovation we have at SKM. It represents the futuristic and progressive face of SKM and embodies the ever-growing enthusiasm and energy in the organization.
            </motion.p>
            <motion.p variants={itemVariants} className="font-body text-[16px] text-surface-500 leading-[30px] m-0">
        ...
        >
          <div className="absolute w-[80%] h-[80%] -left-4 -top-4 bg-brand-600/6 rounded-full blur-3xl group-hover:bg-[rgba(228, 10, 24,0.10)] transition-all duration-500 -z-10 pointer-events-none" />

          <div className="w-full max-w-sm rounded-[20px] border border-[#eee] bg-surface-50 p-6 md:p-8 shadow-[5px_3px_40px_rgba(0,72,88,0.07)] hover:shadow-[5px_3px_40px_rgba(0,72,88,0.16)] transition-all duration-500 overflow-hidden flex flex-col items-center gap-6 justify-center">
            <div className="relative bg-page p-6 rounded-[16px] border border-[#eee] shadow-xs group-hover:shadow-md transition-all duration-300 w-full aspect-square flex items-center justify-center">
              <motion.img
                src={BrandLogo}
            ...
            <div className="text-center flex flex-col gap-1 select-none">
              <h4 className="font-heading text-[15px] font-bold text-heading m-0 tracking-wide">
                SKM Vertical Brand Mark
              </h4>
              <p className="font-body text-[13px] text-surface-400 m-0">
