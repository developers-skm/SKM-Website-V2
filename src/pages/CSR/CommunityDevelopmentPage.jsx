        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="p-5 bg-white border border-[#eee] rounded-[10px] flex flex-col gap-3">
                <h4 className="font-heading font-bold text-[12px] text-heading uppercase tracking-wider m-0">Location &amp; Service Centre</h4>
              ...
              <div className="p-5 bg-white border border-[#eee] rounded-[10px] flex flex-col gap-3">
                <h4 className="font-heading font-bold text-[12px] text-heading uppercase tracking-wider m-0">Holistic Approach</h4>
                <p className="text-sm text-surface-600 leading-relaxed m-0">
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-6">
            <div className="flex flex-col gap-1">
              <span className="font-body text-[12px] font-medium uppercase tracking-widest text-brand-600">Adopted Community</span>
              <h3 className="font-heading font-bold text-[22px] sm:text-[26px] text-heading tracking-tight m-0">Families &amp; Residents</h3>
            </div>
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-6">
            <div className="flex flex-col gap-1">
              <span className="font-body text-[12px] font-medium uppercase tracking-widest text-brand-600">Infrastructure</span>
              <h3 className="font-heading font-bold text-[22px] sm:text-[26px] text-heading tracking-tight m-0">Clean, Green &amp; Healthy Environment</h3>
            </div>
