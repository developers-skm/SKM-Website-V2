        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-6">
            <div className="flex flex-col gap-1">
              <span className="font-body text-[12px] font-medium uppercase tracking-widest text-brand-600">At a Glance</span>
              <h3 className="font-heading font-bold text-[22px] sm:text-[26px] text-heading tracking-tight m-0">Education by the Numbers</h3>
            </div>
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              {educationStats.map((stat, i) => (
                <div key={i} className="p-5 bg-brand-600/4 border border-[rgba(228, 10, 24,0.10)] rounded-[10px] flex flex-col gap-1.5">
                  <span className="font-heading font-bold text-[26px] sm:text-[30px] text-brand-600 leading-tight">{stat.value}</span>
                  <span className="text-[11px] font-bold text-surface-700 leading-tight">{stat.label}</span>
                  {stat.sub && <span className="text-[10px] text-surface-400 leading-tight">{stat.sub}</span>}
                </div>
              ))}
            </div>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-6">
            <div className="flex flex-col gap-1">
              <span className="font-body text-[12px] font-medium uppercase tracking-widest text-brand-600">Primary Education</span>
              <h3 className="font-heading font-bold text-[22px] sm:text-[26px] text-heading tracking-tight m-0">Activities Based Learning</h3>
            </div>
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-6">
            <div className="flex flex-col gap-1">
              <span className="font-body text-[12px] font-medium uppercase tracking-widest text-brand-600">Values &amp; Character</span>
              <h3 className="font-heading font-bold text-[22px] sm:text-[26px] text-heading tracking-tight m-0">Cultural Education</h3>
            </div>
            <p className="text-sm sm:text-base text-surface-600 leading-relaxed m-0">
              Value-based cultural education is taught for children starting from the age of 4 and 5 residing in the two Dalit colonies. In order to inspire and develop students between <strong className="text-surface-700">6th and 12th standard</strong>, value-based <strong className="text-surface-700">Personality Development Course (PDC)</strong> classes are conducted regularly.
            </p>
          ...
          <motion.div variants={itemVariants} className="flex flex-col gap-6">
            <div className="flex flex-col gap-1">
              <span className="font-body text-[12px] font-medium uppercase tracking-widest text-brand-600">Academic Support</span>
              <h3 className="font-heading font-bold text-[22px] sm:text-[26px] text-heading tracking-tight m-0">Coaching Centre</h3>
            </div>
            <p className="text-sm sm:text-base text-surface-600 leading-relaxed m-0">
              At the <strong className="text-surface-700">Vivekanandhar Education Centre</strong>, coaching classes are conducted in the morning (7:00 – 8:30 am) and evening (5:30 – 8:30 pm) with the aid of expert teachers. Computer and English courses are also conducted through specialised teachers. The dalit children studying in 10th and 12th standard have scored <strong className="text-brand-600">centum results</strong> in public exams.
            </p>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <motion.div variants={itemVariants} className="grid grid-cols-1 sm:grid-cols-2 gap-5">
            ...
            <div className="flex flex-col gap-4 p-6 bg-white border border-[#eee] rounded-[10px] hover:border-brand-600/30 hover:shadow-[5px_3px_40px_rgba(0,72,88,0.08)] transition-all duration-300 group">
              <div className="flex items-start gap-4">
                ...
                <h3 className="font-heading font-bold text-[14px] text-heading m-0 tracking-tight leading-snug pt-2">Library</h3>
              </div>
              <p className="text-sm text-surface-600 leading-relaxed m-0">
            ...
            <div className="flex flex-col gap-4 p-6 bg-white border border-[#eee] rounded-[10px] hover:border-brand-600/30 hover:shadow-[5px_3px_40px_rgba(0,72,88,0.08)] transition-all duration-300 group">
              <div className="flex items-start gap-4">
                ...
                <h3 className="font-heading font-bold text-[14px] text-heading m-0 tracking-tight leading-snug pt-2">Meditation &amp; Yoga</h3>
              </div>
              <p className="text-sm text-surface-600 leading-relaxed m-0">
            ...
            <div className="flex flex-col gap-4 p-6 bg-white border border-[#eee] rounded-[10px] hover:border-brand-600/30 hover:shadow-[5px_3px_40px_rgba(0,72,88,0.08)] transition-all duration-300 group">
              <div className="flex items-start gap-4">
                ...
                <h3 className="font-heading font-bold text-[14px] text-heading m-0 tracking-tight leading-snug pt-2">Cultural Activities</h3>
              </div>
              <p className="text-sm text-surface-600 leading-relaxed m-0">
                Specialised teachers appointed by the Trust teach music and dance to the Dalit children. Gandhi Jayanthi is celebrated every year on <strong className="text-surface-700">October 2nd</strong>, with children performing dance and music depicting freedom and patriotism.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-4 p-6 bg-white border border-[#eee] rounded-[10px] hover:border-brand-600/30 hover:shadow-[5px_3px_40px_rgba(0,72,88,0.08)] transition-all duration-300 group">
              <div className="flex items-start gap-4">
                ...
                <h3 className="font-heading font-bold text-[14px] text-heading m-0 tracking-tight leading-snug pt-2">Awards</h3>
              </div>
              <p className="text-sm text-surface-600 leading-relaxed m-0">
                <strong className="text-surface-700">10 schools</strong> including government schools in Erode are chosen every year, and school toppers in 10th and 12th standards are awarded <strong className="text-surface-700">certificates and cash prizes</strong> by the Trust.
              </p>
            </div>
