    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
        {cards.map((card) => (
          <div
            key={card.name}
            className="flex flex-col gap-4 rounded-[22px] border border-surface-200/60 dark:border-surface-800 bg-white dark:bg-surface-900/40 px-6 py-7"
          >
            ...
            {card.guide && (
              <button
                ...
                className="mt-auto self-start inline-flex items-center gap-1.5 font-body font-bold text-[12.5px] uppercase tracking-[0.05em] text-brand-600 dark:text-brand-400 hover:text-[#a80000] cursor-pointer bg-transparent border-none p-0"
              >
