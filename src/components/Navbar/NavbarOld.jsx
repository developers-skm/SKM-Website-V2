...
// Premium fixed navigation shell: logo top-left, floating vertical action
// rail top-right on desktop (RailNav) collapsing to a single compact
// trigger on mobile (MobileMenuTrigger), both opening the same full-screen
// NavOverlay. Component API preserved exactly — <Navbar activePage
  ...
  return (
    <>
      <motion.div
        ...
        className="fixed top-0 left-0 z-40 px-5 sm:px-6 lg:px-8 pt-4 sm:pt-5"
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <img
              ...
              className="w-[130px] sm:w-[160px] lg:w-[190px] max-w-[230px] h-auto object-contain transition-opacity duration-200 hover:opacity-85"
              loading="eager"
            />
          </button>
