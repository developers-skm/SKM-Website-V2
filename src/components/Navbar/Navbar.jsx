    ...
    <>
      ...
      >
        <button
          ...
          className="flex-shrink-0 cursor-pointer select-none focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-600 rounded-lg bg-white/95 border border-black/5 backdrop-blur-md px-3 py-2.5 sm:px-3.5 sm:py-3 shadow-[0_4px_16px_rgba(0,0,0,0.08)] flex items-center"
          aria-label="SKM Egg Products — Home"
        >
          <img
            src={SKMLogo}
            alt="SKM Egg Products"
            className="w-[150px] sm:w-[160px] lg:w-[180px] h-auto object-contain transition-opacity duration-200 hover:opacity-85"
            loading="eager"
          />
        </button>
      </motion.div>

      {/* Fixed to the viewport — the sole persistent navigation control. */}
      <motion.div
        initial={{ y: -24, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
