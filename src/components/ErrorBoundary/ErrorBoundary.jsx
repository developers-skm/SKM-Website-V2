...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-[60vh] flex flex-col items-center justify-center p-6 text-center bg-page">
          <div className="w-16 h-16 rounded-full bg-brand-100 border border-brand-200 flex items-center justify-center mb-6 text-brand-600">
          ...
          <p className="text-surface-600 text-sm max-w-md mb-6 leading-relaxed">
            {isOffline
